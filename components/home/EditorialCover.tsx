...
export default function EditorialCover() {
    return (
        <section className="relative min-h-[95vh] flex items-center bg-slate-950 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-blue-900 via-[#0f172a] to-[#020617] text-white overflow-hidden">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                ...
                <div className="absolute bottom-[-10%] left-[-5%] w-[500px] h-[500px] bg-indigo-500/10 rounded-full blur-[100px] mix-blend-screen" />
            </div>
            ...
            <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10 grid lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-7 space-y-10">
                    <motion.div
                        ...
                        className="flex items-center gap-3 text-blue-200/80 font-medium tracking-[0.2em] uppercase text-xs"
                    >
                    ...
                    <motion.p
                        ...
                        className="text-xl md:text-2xl text-blue-100/80 max-w-xl leading-relaxed font-light"
                    >
                    ...
                    >
                        <button className="group relative px-8 py-4 bg-white text-[#0f172a] font-medium text-lg rounded-sm overflow-hidden transition-all hover:shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)]">
                ...
                <div className="lg:col-span-5 relative h-full flex items-end justify-center lg:justify-end mt-12 lg:mt-0">
                    ...
                    >
                        <div className="absolute inset-0 bg-gradient-to-t from-[#020617] via-transparent to-transparent z-20 opacity-40" />
                        <img
